 ...
 *
 * ```javascript
 * import { AutoTokenizer, ClapTextModelWithProjection } from '@fugood/transformers';
 *
 ...
 *
 * ```javascript
 * import { AutoProcessor, ClapAudioModelWithProjection, read_audio } from '@fugood/transformers';
 *
